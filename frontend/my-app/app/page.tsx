...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center main-h-screen p-8 pb-20 sm:p-20 font-sans bg-gray-100">
      {!user && (
        <div className="w-full max-w-md p-d bg-white rounded-lg shadow-md">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 sm:text-sm text-black"
            />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">
